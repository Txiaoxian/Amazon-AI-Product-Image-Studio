...
type GenerationTask struct {
	...
	ProviderID        string     `gorm:"type:varchar(36);not null;index:idx_generation_tasks_tenant_provider_status,priority:2;index:idx_generation_tasks_tenant_provider_created,priority:2"`
	ModelID           string     `gorm:"type:varchar(36);not null;index:idx_generation_tasks_tenant_model_status,priority:2;index:idx_generation_tasks_tenant_model_created,priority:2"`
	...
	CreatedAt         time.Time  `gorm:"type:datetime(3);not null;index:idx_generation_tasks_tenant_project_created,priority:3;index:idx_generation_tasks_tenant_created_by,priority:3;index:idx_generation_tasks_tenant_created,priority:2;index:idx_generation_tasks_tenant_provider_created,priority:3;index:idx_generation_tasks_tenant_model_created,priority:3"`
	UpdatedAt         time.Time  `gorm:"type:datetime(3);not null"`
}
...
type TaskOutput struct {
	...
	TenantID    string    `gorm:"type:varchar(36);not null;index;uniqueIndex:uk_task_outputs_tenant_id,priority:1;uniqueIndex:uk_task_outputs_tenant_task_index,priority:1;index:idx_task_outputs_tenant_task,priority:1;index:idx_task_outputs_tenant_asset,priority:1;index:idx_task_outputs_tenant_created,priority:1"`
	...
	CreatedAt   time.Time `gorm:"type:datetime(3);not null;index:idx_task_outputs_tenant_created,priority:2"`
}
...
type APICallLog struct {
	ID                   string    `gorm:"type:varchar(36);primaryKey"`
	TenantID             string    `gorm:"type:varchar(36);not null;index;index:idx_api_call_logs_tenant_task,priority:1;index:idx_api_call_logs_tenant_provider,priority:1;index:idx_api_call_logs_tenant_created,priority:1;index:idx_api_call_logs_tenant_provider_created,priority:1;index:idx_api_call_logs_tenant_model_created,priority:1;index:idx_api_call_logs_tenant_status_created,priority:1"`
	TaskID               string    `gorm:"type:varchar(36);not null;index:idx_api_call_logs_tenant_task,priority:2"`
	ProviderID           string    `gorm:"type:varchar(36);not null;index:idx_api_call_logs_tenant_provider,priority:2;index:idx_api_call_logs_tenant_provider_created,priority:2"`
	ModelID              string    `gorm:"type:varchar(36);not null;index;index:idx_api_call_logs_tenant_model_created,priority:2"`
	Status               string    `gorm:"type:varchar(32);not null;index;index:idx_api_call_logs_tenant_status_created,priority:2"`
	...
	CreatedAt            time.Time `gorm:"type:datetime(3);not null;index:idx_api_call_logs_tenant_created,priority:2;index:idx_api_call_logs_tenant_provider_created,priority:3;index:idx_api_call_logs_tenant_model_created,priority:3;index:idx_api_call_logs_tenant_status_created,priority:3"`
}
...
type UsageRecord struct {
	ID                  string    `gorm:"type:varchar(36);primaryKey"`
	TenantID            string    `gorm:"type:varchar(36);not null;index;index:idx_usage_records_tenant_task,priority:1;index:idx_usage_records_tenant_project_created,priority:1;index:idx_usage_records_tenant_user_created,priority:1;index:idx_usage_records_tenant_created,priority:1;index:idx_usage_records_tenant_provider_created,priority:1;index:idx_usage_records_tenant_model_created,priority:1"`
	...
	ProviderID          string    `gorm:"type:varchar(36);not null;index;index:idx_usage_records_tenant_provider_created,priority:2"`
	ModelID             string    `gorm:"type:varchar(36);not null;index;index:idx_usage_records_tenant_model_created,priority:2"`
	...
	CostStatus          string    `gorm:"type:varchar(32);not null;default:LEGACY_UNKNOWN"`
	PricingSnapshotJSON string    `gorm:"type:json"`
	RawUsageJSON        string    `gorm:"type:json"`
	CreatedAt           time.Time `gorm:"type:datetime(3);not null;index:idx_usage_records_tenant_project_created,priority:3;index:idx_usage_records_tenant_user_created,priority:3;index:idx_usage_records_tenant_created,priority:2;index:idx_usage_records_tenant_provider_created,priority:3;index:idx_usage_records_tenant_model_created,priority:3"`
}
