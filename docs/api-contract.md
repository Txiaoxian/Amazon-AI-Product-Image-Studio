...
- Orphan object listing and manual cleanup triggers remain absent from `system-settings`. P17 may add dedicated admin storage endpoints with real runtime behavior, but they must not appear as writable settings without a consumer.
