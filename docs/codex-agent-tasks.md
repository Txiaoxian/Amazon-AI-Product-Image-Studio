...
- 后端用户/角色管理接口已完成；前端用户/角色管理还没有形成产品化使用界面。
...
除非用户选择其他顺序，否则下一个任务应生成 `P11-FE-USER-ROLE-ADMIN`。

推荐分支：

```text
codex/p11-frontend-user-role-admin
```
...
- P11 后端用户/角色管理已完成并合并。
- 下一步串行执行前端用户/角色管理 UI，不与 P12/P13 并行。
