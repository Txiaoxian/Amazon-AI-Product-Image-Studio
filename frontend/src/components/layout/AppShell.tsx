...
export function AppShell({ accountSlot, children, immersive = false, notice, onOpenSettings }: AppShellProps) {
  ...
  return (
    <div className="app-root-shell min-h-screen text-ink-900">
      <a
      ...
      <main className={immersive ? 'w-full' : 'mx-auto w-full max-w-[1920px] px-2 py-2 sm:px-3 sm:py-3 lg:px-4'} id="main-content">
        {children}
      </main>
    </div>
  )
